...
BACKGROUND_COLOR = (0,125,200,200)
...
POS_TITLE = [LEFT_POS_0, 10]
POS_DATE = [LEFT_POS_2, 60]

POS_SLIDER = [0,0]
POS_APPOINTMENT_TIME = [LEFT_POS_1, 120]
POS_APPOINTMENT_PLACE = [LEFT_POS_1, 120 + LINE_INTERVAL]
POS_FROM = [LEFT_POS_1, 120 + LINE_INTERVAL * 2]
POS_SUGGESTED_START_TIME = [LEFT_POS_2, 120 + LINE_INTERVAL * 3.5]
POS_TTA_CERTAINTY = [LEFT_POS_2, 120 + LINE_INTERVAL * 4.5]
POS_ZOOM_LEVEL = [LEFT_POS_2, PANEL_HEIGHT - 40]

RIGHT_POS_0 = 100
RIGHT_POS_1 = 170
RIGHT_POS_2 = 100

POS_OUTPUT_APPOINTMENT_TIME = [LEFT_POS_1+RIGHT_POS_0, 120]
POS_OUTPUT_APPOINTMENT_PLACE = [LEFT_POS_1+RIGHT_POS_0, 120 + LINE_INTERVAL]
POS_OUTPUT_FROM = [LEFT_POS_1+RIGHT_POS_0, 120 + LINE_INTERVAL * 2]
POS_OUTPUT_SUGGESTED_START_TIME = [LEFT_POS_2+RIGHT_POS_1, 120 + LINE_INTERVAL * 3.5]
POS_OUTPUT_TTA_CERTAINTY = [LEFT_POS_2+RIGHT_POS_1, 120 + LINE_INTERVAL * 4.5]
POS_OUTPUT_ZOOM_LEVEL = [LEFT_POS_2+RIGHT_POS_2, PANEL_HEIGHT - 40]
