...
POS_SLIDER_ZOOM_LEVEL = [LEFT_POS_2, 140 + LINE_INTERVAL * 5.5 + 200 + 20 + 20 ]
POS_SLIDER_TIME = [LEFT_POS_2, PANEL_HEIGHT - 25 ]
...
def main():
	...
	sub_canvas = Canvas(map_canvas,320,240)
	kpbc = KaoPuBaseChart.KaoPuBaseChart(sub_canvas, 320,240)
	kpbc.draw()
